...
// HACK
// look from source:
// https://github.com/vitejs/vite/blob/main/packages/vite/src/node/logger.ts#L144
// https://github.com/alexeyraspopov/picocolors/blob/main/picocolors.js#LL31C29-L31C48
